...
@Component({
  selector: 'app-report-cantidad-venta',
  templateUrl: './report-cantidad-venta.component.html',
  styleUrls: ['./report-cantidad-venta.component.css']
})
export class ReportCantidadVentaComponent extends ReportBaseComponent implements OnInit {
  ...
  reportSubtitle(): string {
    return "Reporte de Cantidad de Ventas";
  }

  reportType(): string {
    return 'ventabysucursal';
  }
