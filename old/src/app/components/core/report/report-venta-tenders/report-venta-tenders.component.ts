...
@Component({
  selector: 'app-report-venta-tenders',
  templateUrl: './report-venta-tenders.component.html',
  styleUrls: ['./report-venta-tenders.component.css']
})
export class ReportVentaTendersComponent extends ReportBaseComponent implements OnInit {
  ...
  reportSubtitle(): string {
    return "Reporte de Ventas con Formas de Pago";
  }
